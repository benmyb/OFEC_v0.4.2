...
static int BetaValue(LKH::LKHAlg::Node * From, LKH::LKHAlg::Node * To, LKH::LKHAlg * Alg);
static LKH::LKHAlg::Candidate *FindCandidate(LKH::LKHAlg::Node * From, LKH::LKHAlg::Node * To);
#undef max
static int max(const int a, const int b);

void LKH::LKHAlg::OrderCandidateSet(int MaxCandidates, GainType MaxAlpha, int Symmetric)
{
    Node *From, *To, *N;
    Candidate *NFrom, *NN;
    int Alpha, Beta;
