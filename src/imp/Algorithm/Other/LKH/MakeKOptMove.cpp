...
void LKH::LKHAlg::MakeKOptMove(int K)
{
  ...
  FindNextReversal:
    ...
    if (BestScore >= 0) {
        ...
        j = Best_j;
        if (i & 1) {
            Swap1((*t.get())[(*p.get())[i + 1]], (*t.get())[(*p.get())[i]], (*t.get())[(*p.get())[j]]);
            Reverse(i + 1, j);
        } else {
            Swap1((*t.get())[(*p.get())[i - 1]], (*t.get())[(*p.get())[i]], (*t.get())[(*p.get())[j]]);
            Reverse(i, j - 1);
    ...
    for (i = 1; i <= 2 * K - 3; i += 2) {
        j = (*q.get())[(*incl.get())[(*p.get())[i]]];
        if (j >= i + 3) {
            Swap1((*t.get())[(*p.get())[i]], (*t.get())[(*p.get())[i + 1]], (*t.get())[(*p.get())[j]]);
            Reverse(i + 1, j - 1);
            goto FindNextReversal;
        }
    }
