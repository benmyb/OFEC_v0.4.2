...
void freeAll();
char *savePtr;
double m_Gap,m_AscentTime,m_CandMin,m_CandAve,m_CandMax;
static vector<double> mv_cost;

struct Node {

	Node()
	{
		C=0; Pred=0; Suc=0; OldPred=0; OldSuc=0; BestSuc=0; NextBestSuc=0; Dad=0; Nearest=0; Next=0; Prev=0;
		Mark=0; FixedTo1=0; FixedTo2=0; FixedTo1Saved=0; FixedTo2Saved=0; Head=0; Tail=0; InputSuc=0; InitialSuc=0;
		SubproblemPred=0; SubproblemSuc=0; SubBestPred; SubBestSuc=0; MergeSuc=0; Added1=0; Added2=0; Deleted1=0;
		Deleted2=0; CandidateSet=0; BackboneCandidateSet=0; Parent=0;
	}
...
struct Segment {
	Segment()
	{
		First=0; Last=0; Pred=0; Suc=0; Parent=0;
	}
