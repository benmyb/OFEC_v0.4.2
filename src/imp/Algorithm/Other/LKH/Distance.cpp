...
int LKH::LKHAlg::Distance_1(Node * Na, Node * Nb)
{
    return 1;
}

int LKH::LKHAlg::Distance_ATSP(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::Distance_ATT(Node * Na, Node * Nb)
{
    double xd = Na->X - Nb->X, yd = Na->Y - Nb->Y;
    return (int) ceil(sqrt((xd * xd + yd * yd) / 10.0));
}

int LKH::LKHAlg::Distance_CEIL_2D(Node * Na, Node * Nb)
{
    double xd = Na->X - Nb->X, yd = Na->Y - Nb->Y;
    return (int) ceil(sqrt(xd * xd + yd * yd));
}

int LKH::LKHAlg::Distance_CEIL_3D(Node * Na, Node * Nb)
{
    double xd = Na->X - Nb->X, yd = Na->Y - Nb->Y, zd = Na->Z - Nb->Z;
    return (int) ceil(sqrt(xd * xd + yd * yd + zd * zd));
}

int LKH::LKHAlg::Distance_EUC_2D(Node * Na, Node * Nb)
{
    double xd = Na->X - Nb->X, yd = Na->Y - Nb->Y;
    return (int) (sqrt(xd * xd + yd * yd) + 0.5);
}

int LKH::LKHAlg::Distance_EUC_3D(Node * Na, Node * Nb)
{
    double xd = Na->X - Nb->X, yd = Na->Y - Nb->Y, zd = Na->Z - Nb->Z;
    return (int) (sqrt(xd * xd + yd * yd + zd * zd) + 0.5);
}

int LKH::LKHAlg::Distance_EXPLICIT(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::Distance_GEO(Node * Na, Node * Nb)
{
    int deg;
...
int LKH::LKHAlg::Distance_GEOM(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::Distance_MAN_2D(Node * Na, Node * Nb)
{
    return (int) (fabs(Na->X - Nb->X) + fabs(Na->Y - Nb->Y) + 0.5);
}

int LKH::LKHAlg::Distance_MAN_3D(Node * Na, Node * Nb)
{
    return (int) (fabs(Na->X - Nb->X) +
                  fabs(Na->Y - Nb->Y) + fabs(Na->Z - Nb->Z) + 0.5);
}

int LKH::LKHAlg::Distance_MAX_2D(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::Distance_MAX_3D(Node * Na, Node * Nb)
{
    int dx = (int) (fabs(Na->X - Nb->X) + 0.5),
        dy = (int) (fabs(Na->Y - Nb->Y) + 0.5),
...
int LKH::LKHAlg::Distance_GEO_MEEUS(Node * Na, Node * Nb)
{
    double lat1 =
...
int LKH::LKHAlg::Distance_GEOM_MEEUS(Node * Na, Node * Nb)
{
