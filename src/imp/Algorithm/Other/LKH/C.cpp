...
int LKH::LKHAlg::C_EXPLICIT(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::C_FUNCTION(Node * Na, Node * Nb)
{
    Node *Nc;
    Candidate *Cand;
    int Index, i, j;
...
int LKH::LKHAlg::D_EXPLICIT(Node * Na, Node * Nb)
{
    return (Na->Id <
            Nb->Id ? Nb->C[Na->Id] : Na->C[Nb->Id]) + Na->Pi + Nb->Pi;
}

int LKH::LKHAlg::D_FUNCTION(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::c_ATT(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::c_CEIL_2D(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::c_CEIL_3D(Node * Na, Node * Nb)
{
    int dx = (int) ceil(fabs(Na->X - Nb->X)),
        dy = (int) ceil(fabs(Na->Y - Nb->Y)),
...
int LKH::LKHAlg::c_EUC_2D(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::c_EUC_3D(Node * Na, Node * Nb)
{
    int dx = (int) (fabs(Na->X - Nb->X) + 0.5),
        dy = (int) (fabs(Na->Y - Nb->Y) + 0.5),
...
int LKH::LKHAlg::c_GEO(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::c_GEOM(Node * Na, Node * Nb)
{
...
int LKH::LKHAlg::c_GEO_MEEUS(Node * Na, Node * Nb)
{
    int da = (int) Na->X, db = (int) Nb->X;
    double ma = Na->X - da, mb = Nb->X - db;
    int dx =
...
int LKH::LKHAlg::c_GEOM_MEEUS(Node * Na, Node * Nb)
{
