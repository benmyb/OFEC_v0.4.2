...
static void SplitSegment(LKH::LKHAlg::Node * t1, LKH::LKHAlg::Node * t2);
static void SplitSSegment(LKH::LKHAlg::Segment * t1, LKH::LKHAlg::Segment * t2);
static void FlipNodes(LKH::LKHAlg::Node * a, LKH::LKHAlg::Node * b, LKH::LKHAlg::Node * c, LKH::LKHAlg::Node * d, LKH::LKHAlg * Alg);
static void FlipSegments(LKH::LKHAlg::Segment * a, LKH::LKHAlg::Segment * b,
                         LKH::LKHAlg::Segment * c, LKH::LKHAlg::Segment * d);
static void FlipSSegments(LKH::LKHAlg::SSegment * a, LKH::LKHAlg::SSegment * b,
                          LKH::LKHAlg::SSegment * c, LKH::LKHAlg::SSegment * d);

#define SPLIT_CUTOFF 0.75

void LKH::LKHAlg::Flip_SSL(Node * t1, Node * t2, Node * t3)
{
    ...
    if (b)
        ...
        FlipNodes(a, b, c, d,this);
    else {
        Segment *a=0, *b, *c=0, *d=0, *t1 = P1, *t2 = P2, *t3 = P3, *t4 = P4;
    ...
    if (!b) {
        int Ct2t3 = (this->*C)(t2, t3), Ct4t1 = (this->*C)(t4, t1);
        if (t3->Suc == t4) {
            t3->Suc = t2;
            t3->SucCost = Ct2t3;
        } else {
...
static void SplitSegment(LKH::LKHAlg::Node * t1, LKH::LKHAlg::Node * t2)
{
    LKH::LKHAlg::Segment *P = t1->Parent, *Q;
    LKH::LKHAlg::Node *t, *u;
    int i, Count, Temp;
...
static void SplitSSegment(LKH::LKHAlg::Segment * t1, LKH::LKHAlg::Segment * t2)
{
    LKH::LKHAlg::SSegment *P = t1->Parent, *Q;
    LKH::LKHAlg::Segment *t, *u;
    int i, Count;
...
static void FlipNodes(LKH::LKHAlg::Node * a, LKH::LKHAlg::Node * b, LKH::LKHAlg::Node * c, LKH::LKHAlg::Node * d, LKH::LKHAlg * Alg)
{
    LKH::LKHAlg::Node *s1, *s2 = b;
    int i = d->Rank, Temp, Cbc = (Alg->*(Alg->C))(b, c), Cda = (Alg->*(Alg->C))(d, a);
