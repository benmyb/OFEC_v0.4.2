...
static void KMeansClustering(int K, LKH::LKHAlg *Alg);

void LKH::LKHAlg::SolveKMeansSubproblems()
{
    Node *N;
...
static void KMeansClustering(int K, LKH::LKHAlg *Alg)
{
    LKH::LKHAlg::Node *Center, **Perm, *N, Old;
    ...
    assert(Perm = (LKH::LKHAlg::Node **) malloc(Alg->Dimension * sizeof(LKH::LKHAlg::Node *)));
