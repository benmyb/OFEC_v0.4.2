...
enum ProTag{SOP,MOP,DOP,MMP,SMP,ROOT,CONT,COMB,TSP,COP,VRP,TTP,JSP,KOP,SAT,ONEMAX, QAP, MKP};
...
enum ReturnFlag{Return_Normal=0,Return_Change,Return_Terminate,Return_ChangeNextEval,Return_Change_Timelinkage,Return_Loop\
	,Return_Change_Dim,Return_Error,Return_Invalid};
enum CompareResultFlag{Compare_Equal=0,Compare_Better,Compare_Worse,Compare_Non_Dominated,Compare_Non_Comparable};

enum PopInitMethod{POP_INIT_UNIFORM = 0, POP_INIT_ORTHONORM, POP_INIT_CENTER, POP_INIT_USER_DEFINED, POP_INIT_HEURIS, POP_INIT_LKHAndRandom, POP_INIT_NEAR_NEIGHBOR\
	, POP_INIT_AS, POP_INIT_ACS, POP_INIT_MMAS
};
