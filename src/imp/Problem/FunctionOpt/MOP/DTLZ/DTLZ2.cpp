...
DTLZ2::DTLZ2(ParamMap &v) :Problem((v[param_proId]), (v[param_numObj] + v[param_interTest1] - 1), (v[param_proName]), v[param_numObj]), \
DTLZ((v[param_proId]), (v[param_numObj] + v[param_interTest1] - 1), (v[param_proName]), v[param_numObj])
{
	//default value m_k=10;
}

void DTLZ2::evaluate__(double const *x,vector<double>& obj)
{
	double g = 0;
